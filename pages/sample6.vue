<template>
    ...
    <div class = "main-container6">
        <img src = "/asset/sample6-couple.png">
        <div class = "wel-wedding">​សិរីសួស្តីអាពាហ៍ពិពាហ៍</div>
        <div style = "margin-top : 30px;">
            <table class = "couple-table">
            <tr class = "groom-bride" style ="color : #d8ad83;">
                <td>កូនប្រុសនាម</td>
                <td>កូនស្រីនាម</td>
            </tr>
            <tr class = "name-groombride" style = "color : #d8ad83 ; font-family : battambang ; font-weight : 700 ; font-size : 24px;">
                <td>សាយ​ តារា</td>
                <td>លួន​ តារារស្មី</td>
            </tr>
            </table>
      ...
      <table class = "parent-name">
            <tr class = "top-name">
              <td style = "color : #d8ad83 ; font-family : battambang ; font-size : 20px ; font-weight : 700;">លោក​ យឹម តាវសាយ</td>
              <td style = "color : #d8ad83; font-family : battambang ; font-size : 20px ; font-weight : 700;">លោក​ ខឹម សាលួន</td>
            </tr>
            <tr class = "down-name">
              <td style = "color :#d8ad83 ; font-family : battambang ; font-size : 20px ; font-weight : 700;">លោក​ស្រី ម៉ា ឡាវី</td>
              <td style = "color : #d8ad83; font-family : battambang ; font-size : 20px ; font-weight : 700;">លោកស្រី យ៉ាក់ ភួង</td>
            </tr>
        </table>
        <div class = "thanks-text" style = "color :#d8ad83 ;">
        ...
        <table>
            <tr>
              <td style="padding: 10px;">
                <div class = "top-groom" style = "color : #d8ad83 ;">កូនប្រុសនាម</div>
                <div class = "grooms-name" style = "color : #d8ad83 ; font-family : battambang ; font-weight : 700 ; font-size : 28px; margin-left : 20px ; margin-right : 20px;">សាយ​ តារា</div>
              </td>
              <td><img style = "width: 140px; height: 133px; object-fit : contain;"src="/asset/coupleLogo.png" alt="Image"></td>
              <td style="padding: 10px;">
                <div class = "top-groom" style = "color : #d8ad83 ;">កូនស្រីនាម</div>
                <div class = "grooms-name" style = "color : #d8ad83;font-family : battambang ; font-weight : 700 ; font-size : 28px; margin-left : 20px ; margin-right : 20px;">លួន តារា</div>
              </td>
            </tr>
          </table>
          <div class = "invite" style = "color : #d8ad83 ;">ដែលនិងប្រព្រឹត្តទៅនៅ</div>
        ...
        <div class = "content-box">
          <div class="content active">
            <div class = "header" style = "font-family: Khmer;font-size: 24px; color: #d8ad83;">កម្មវិធីពេលរសៀល</div>
            <div class = "vertical-line" style = "background-color:#d8ad83;"></div>
            <div class = "event-text" style = "font-family: khmer; font-size: 16px; color: #d8ad83;">ម៉ោង ៣​ រសៀល</div>
            <div class = "event-text"style = "font-family: khmer; font-size: 16px; color: #d8ad83;">ពិធីសូត្រមន្តចម្រើនព្រះបរិត្ត</div>
  
            <div class = "vertical-line"style = "background-color: #d8ad83;"></div>
            <div class = "event-text" style = "font-family: khmer; font-size: 16px;color: #d8ad83;">ម៉ោង ៥ ល្ងាច</div>
            <div class = "event-text"style = "font-family: khmer; font-size: 16px; color:#d8ad83;">
          ...
          <div class="content">
            ...
            <div class = "vertical-line" style = "background-color: #d8ad83;"></div>
            <div class = "event-text" style = "font-family: khmer; font-size: 14px; color: #d8ad83;">ម៉ោង ០៦:៣០​ ព្រឹក</div>
            <div class = "event-text" style = "font-family: khmer; font-size: 14px;color: #d8ad83;">ជួបជុំភ្ញៀវកិត្តិយសដើម្បីរៀបចំហែជំនូននៅគេហដ្ឋាន
              ខាងស្រីនៅខណ្ឌទួលគោក</div>
  
            <div class = "vertical-line"style = "background-color: #d8ad83;"></div>
            <div class = "event-text"style = "font-family: khmer; font-size: 14px; color: #d8ad83;">ម៉ោង ០៧:០០​ ព្រឹក</div>
            <div class = "event-text"style = "font-family: khmer; font-size: 14px; color: #d8ad83;">
              ពិធីហែជំនូន (កំណត់)
            </div>
  
            <div class = "vertical-line" style = "background-color: #d8ad83;"></div>
            <div class = "event-text"style = "font-family: khmer; font-size: 14px; color: #d8ad83;">ម៉ោង ០៨:០០​ ព្រឹក</div>
            <div class = "event-text"style = "font-family: khmer; font-size: 14px; color: #d8ad83;">
              ពិធីពិសាស្លាកំណត់
            </div>
  
            <div class = "vertical-line"style = "background-color:#d8ad83;"></div>
            <div class = "event-text"style = "font-family: khmer; font-size: 14px; color: #d8ad83;">ម៉ោង ០៨:៣០​ ព្រឹក</div>
            <div class = "event-text"style = "font-family: khmer; font-size: 14px; color: #d8ad83;">
              ពិធីបំពាក់ចិញ្ចៀន
            </div>
  
            <div class = "vertical-line"style = "background-color: #d8ad83;"></div>
            <div class = "event-text"style = "font-family: khmer; font-size: 14px; color: #d8ad83;">ម៉ោង ០៩:០០​ ព្រឹក</div>
            <div class = "event-text"style = "font-family: khmer; font-size: 14px; color: #d8ad83;">
              ពិធីកាត់សក់បង្កក់សិរី
            </div>
  
            <div class = "vertical-line"style = "background-color: #d8ad83;"></div>
            <div class = "event-text"style = "font-family: khmer; font-size: 14px; color: #d8ad83;">ម៉ោង ១០:០០​ ព្រឹក</div>
            <div class = "event-text"style = "font-family: khmer; font-size: 14px; color: #d8ad83;">
              ពិធីសែនផ្ទឹម សែនចងដៃ និងបាចផ្កាស្លា
            </div>
  
            <div class = "vertical-line"style = "background-color: #d8ad83;"></div>
            <div class = "event-text"style = "font-family: khmer; font-size: 14px; color: #d8ad83;">ម៉ោង ១២:០០​ ព្រឹក</div>
            <div class = "event-text"style = "font-family: khmer; font-size: 14px; color: #d8ad83;">
              អញ្ជើញភ្ញៀវពិសាអាហារពេលថ្ងៃត្រង់នៅគេហដ្ឋានខាងស្រីផ្លូវលេខ ៥៨០ សង្កាត់បឹងកក់២ ខណ្ឌទួលគោក រាជធានីភ្នំពេញ
            </div>
  
            <div class = "header" style = "font-family: Khmer;font-size: 24px; color: #d8ad83;margin-top: 40px;">កម្មវិធីពេលល្ងាច</div>
            <div class = "vertical-line"style = "background-color:#d8ad83;"></div>
            <div class = "event-text"style = "font-family: khmer; font-size: 14px; color: #d8ad83;">ម៉ោង ០៥:០០​ ល្ងាច</div>
            <div class = "event-text"style = "font-family: khmer; font-size: 14px; color: #d8ad83;">
...
(OCIC) អគារ F&G
      ...
      <div class = "mar-bot">
          ...
          <div class = "app-power" style = "color : #d8ad83;"> Powered By : The Wedding App</div>
