<template>
    ...
    <div class = "main-container5">
        <img class = "flower5"src = "/asset/flower5-top.png">
        <div class = "welcome-text"> PLEASE JOIN US</div>
        <div class = "welcome-text"> FOR THE WEDDING CELEBRATION OF</div>
        <img style = "margin-top : 20px ; margin-bottom : 20px;"src = "/asset/sample5-couple.png">
        <div class = "couple5-name">Sebastian</div>
        <div class = "couple5-name">&</div>
        <div class = "couple5-name">Rachelle</div>
        <img class = "flower5"src = "/asset/flower5-down.png">
      ...
      <div class = "month" style = "margin-top : 30px;">
        february
      </div>
